#!/usr/bin/env python3
import predict_nn as pl
import make_votes_nn as mvl
import inquire_nn as inquire
import datetime
import sys
...
def agreegate(target, days = 31):
    ...
    while dur < days:
        ...
        if result:
            (total_race, total_bet_race, total_bet, tierce_count, tierce_inquire, trio_count, trio_inquire, tierce_one_count, tierce_one_inquire, win_count, win_inquire) = result
